...
const searchSubCategory = async (req, res) => {
  try {
    ...
    const subcategoriesWithCategoryInfo = subcategories.map(subcategory => ({
      ...
      categoryName: subcategory.category ? subcategory.category.categoryName : null,
    ...
    res.status(200).json({
      status: 200,
      data: subcategoriesWithCategoryInfo,
...
const SubCategoryById = async (req, res) => {
  try {
    ...
    const categoryName = subcategory.category ? subcategory.category.categoryName : null;
...
const deleteSubCategory = async (req, res) => {
  ...
  try {
    ...
    if (products > 0) {
      return res.status(400).json({ message: 'Cannot delete category with attached a product.' });
    }
...
module.exports = {createSubCategory , searchSubCategory , SubCategoryById , updateSubCategory , deleteSubCategory };